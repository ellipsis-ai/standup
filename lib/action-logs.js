...
return function(optionalChannel, ellipsis) {
  return {
    ...
    summaryLogs: summaryLogsFn(ellipsis),
...
function logsFor(actionName, from, to, ellipsis, optionalUser, optionalEventType) {
...
function logsByChannelFn(actionName, ellipsis, optionalStartTimestamp, optionalEndTimestamp, optionalEventType) {
  return function(optionalStartTimestamp, optionalEndTimestamp) {
    const from = optionalStartTimestamp || queryWindowStartFor(ellipsis);
    return logsFor(actionName, from, optionalEndTimestamp, ellipsis, null, optionalEventType)
...
function summaryLogsFn(ellipsis, optionalStartTimestamp, optionalEndTimestamp) {
  return logsByChannelFn('Standup status summary', ellipsis, optionalStartTimestamp, optionalEndTimestamp, "scheduled");
}
