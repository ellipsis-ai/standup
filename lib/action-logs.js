...
function logsByChannelFn(actionName, ellipsis, optionalStartTimestamp, optionalEndTimestamp) {
...
function summaryLogsFn(ellipsis, optionalStartTimestamp, optionalEndTimestamp) {
  return logsByChannelFn('Standup status summary', ellipsis, optionalStartTimestamp, optionalEndTimestamp);
}
